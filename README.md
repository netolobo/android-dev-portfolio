...
### Ricky and Morty App:
I have developed a user-friendly Android application that efficiently consumes a REST API, leveraging the latest technologies in Android development.
...
https://github.com/netolobo/RickyMortyApp
